...
def add_qa_volume(prs):
    ...
    data_table(
        ...
        [
            ["Completed not received (market place)",
             ("47.5", "red"), ("4", "red"), ("Too few", "red")],
            ["Active order, already received",
             ("65.8", "red"), ("12", "amber"), ("Watch", "amber")],
            ["Completed not received (full service)",
             ("68.2", "red"), ("49", "green"), ("Start", "green")],
            ["Verbal aggression",
             ("76.0", "red"), ("5", "red"), ("Too few", "red")],
            ["Refund status and conditions",
             ("76.4", "red"), ("25", "green"), ("Start · Phone", "green")],
        ],
    ...
    data_table(
        ...
        [
            ["Completed not received (full service)",
             ("37", "red"), ("7.1%", "red"), ("14", "red")],
            ["Cancel the order",
             ("25", "amber"), ("4.8%", "amber"), ("5", "amber")],
            ["After-sales fraud review",
             ("23", "amber"), ("4.4%", "amber"), ("4", "amber")],
            ["Cash order blocked (antifraud)",
             ("21", "amber"), ("4.1%", "amber"), ("4", "amber")],
            ["Incomplete order",
             ("21", "amber"), ("4.1%", "amber"), ("7", "amber")],
        ],
...
def add_csat_volume(prs):
    ...
    data_table(
        ...
        [
            ["After-sales fraud review",
             ("6.1%", "red"), "475", ("2.9%", "green")],
            ["Other (unmapped Business Type)",
             ("26.5%", "red"), "558", ("2.6%", "green")],
            ["Membership program renewal",
             ("28.6%", "red"), "248", ("1.1%", "green")],
            ["Membership program benefits",
             ("43.1%", "red"), "109", ("0.4%", "green")],
            ["Placing an order information",
             ("50.7%", "red"), "142", ("0.5%", "green")],
        ],
    ...
    data_table(
        ...
        [
            ["Order status / delay information",
             ("3,189", "red"), ("20.6%", "red"), ("67.8%", "red")],
            ["Disagrees with cancellation charge",
             ("1,951", "red"), ("12.6%", "red"), ("67.4%", "red")],
            ["Order status & delays",
             ("1,800", "red"), ("11.6%", "red"), ("64.7%", "red")],
            ["No longer wants the order",
             ("1,229", "amber"), ("7.9%", "amber"), ("88.3%", "green")],
            ["Refund status and conditions",
             ("1,181", "amber"), ("7.6%", "amber"), ("67.0%", "red")],
        ],
        header_h=0.36, row_h=0.46, heat_cols=(1, 2, 3),
        align_right=(1, 2, 3), size=8, bold_first=True,
    )
